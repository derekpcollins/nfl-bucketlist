...
const cloneTemplate = () => {
	...
	const template = document.getElementById("stadium-template");
...
const addStadiums = (data) => {
	const stadiumsListEl = document.getElementById("stadiums-list");
	...
	data.forEach(function (stadium) {
		...
		stadiumTemplate.querySelector(".location").innerText =
			stadium.location.city + ", " + stadium.location.state;
		stadiumTemplate.querySelector(".team-logo").src =
			"../assets/img/nfl-team-logos/" + teamName + ".png";
